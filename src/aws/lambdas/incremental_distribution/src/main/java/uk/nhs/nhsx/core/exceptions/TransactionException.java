...
public class TransactionException extends RuntimeException {
    ...
    public TransactionException(TransactionCanceledException transactionCanceledException) {
        ...
        this.nestedTransactionCanceledException = transactionCanceledException;
    }
    ...
    public boolean isConditionFailure() {
        return nestedTransactionCanceledException.getCancellationReasons()
            .stream()
            .anyMatch(reason -> reason.getCode().equals("ConditionalCheckFailed"));
    }
}
