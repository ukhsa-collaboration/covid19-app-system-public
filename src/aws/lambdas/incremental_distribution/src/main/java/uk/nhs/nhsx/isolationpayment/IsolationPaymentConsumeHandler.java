...
public class IsolationPaymentConsumeHandler implements RequestHandler<IsolationRequest, IsolationResponse>  {
    ...
    public IsolationPaymentConsumeHandler(Environment environment, Supplier<Instant> clock, Events events) {
        this(isolationPaymentService(clock, environment, events), events);
    }

    public IsolationPaymentConsumeHandler(IsolationPaymentGatewayService service, Events events) {
        this.service = service;
        this.events = events;
    }

    private static IsolationPaymentGatewayService isolationPaymentService(Supplier<Instant> clock, Environment environment, Events events) {
