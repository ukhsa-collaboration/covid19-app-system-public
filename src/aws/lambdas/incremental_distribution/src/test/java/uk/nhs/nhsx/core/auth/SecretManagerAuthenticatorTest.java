...
public class SecretManagerAuthenticatorTest {
    ...
    private final SecretManagerAuthenticator authenticator = new SecretManagerAuthenticator(ApiName.TestResultUpload, secretManager);
