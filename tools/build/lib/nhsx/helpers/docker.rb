module NHSx
  ...
  module Docker
    ...
    CONPAN = "123456789012.dkr.ecr.eu-west-2.amazonaws.com/nhsx-covid19:conpan".freeze
    ...
    # Publish the control panel docker container image to the ECR registry
     def publish_conpan_image(system_config)
      registry_login(system_config)
      cmdline = Commandlines.push_image("#{CONPAN}-latest")
      run_command("Publish #{CONPAN}-latest", cmdline, system_config)
    end
