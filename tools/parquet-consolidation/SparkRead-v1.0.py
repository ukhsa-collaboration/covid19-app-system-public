...
Transform2 = ApplyMapping.apply(frame=Transform1,
                                mappings=[("submitteddatehour", "string",
                                          ...
                                          ("negativeLabResultAfterPositiveSelfRapidTestOutsideTimeLimit", "int",
                                           "negativeLabResultAfterPositiveSelfRapidTestOutsideTimeLimit", "int"),
                                          ("didAccessRiskyVenueM2Notification", "int",
                                           "didAccessRiskyVenueM2Notification", "int"),
                                          ("selectedTakeTestM2Journey", "int",
                                           "selectedTakeTestM2Journey", "int"),
                                          ("selectedTakeTestLaterM2Journey", "int",
                                           "selectedTakeTestLaterM2Journey", "int"),
                                          ("selectedHasSymptomsM2Journey", "int",
                                           "selectedHasSymptomsM2Journey", "int"),
                                          ("selectedHasNoSymptomsM2Journey", "int",
                                           "selectedHasNoSymptomsM2Journey", "int"),
                                          ("selectedLFDTestOrderingM2Journey", "int",
                                           "selectedLFDTestOrderingM2Journey", "int"),
                                          ("selectedHasLFDTestM2Journey", "int",
                                           "selectedHasLFDTestM2Journey", "int"),
                                          ("optedOutForContactIsolation", "int",
                                           "optedOutForContactIsolation", "int"),
                                          ("optedOutForContactIsolationBackgroundTick", "int",
                                           "optedOutForContactIsolationBackgroundTick", "int"),
                                          ("appIsUsableBackgroundTick", "int",
                                           "appIsUsableBackgroundTick", "int"),
                                          ("appIsContactTraceableBackgroundTick", "int",
                                           "appIsContactTraceableBackgroundTick", "int"),
                                          ("didAccessSelfIsolationNoteLink", "int",
                                           "didAccessSelfIsolationNoteLink", "int"),
                                          ("appIsUsableBluetoothOffBackgroundTick", "int",
                                           "appIsUsableBluetoothOffBackgroundTick", "int")],
